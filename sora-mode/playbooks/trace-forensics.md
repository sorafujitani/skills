...
1. Identify the format and load it with the right tool. Parse large artifacts in a subagent (the **guard-the-context-window** principle) and keep the reduced finding in the main thread.
