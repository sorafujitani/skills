...
1. Route through **how** (Explain mode for narrow questions, Critique mode for "are we sure?"). For motivation questions, also run the **why** dig.
...
4. Write the reply per **Writing the reply**.
